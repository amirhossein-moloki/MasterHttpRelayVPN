...
- سهمیه مصرف روزانه شما هر روز رأس ساعت **10:30 صبح** به وقت ایران ریست می‌شود.
...
- از بخش **Routing Rules** در محیط گرافیکی می‌توانید به دقت تعیین کنید که چه دامنه یا آی‌پی‌هایی به صورت مستقیم (Direct)، رله (Relay) یا مسدود (Block) باشند.
---
